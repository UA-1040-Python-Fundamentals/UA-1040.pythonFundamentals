...
def s_triangle_geron() -> int:
    """
    The function receives three numerical values. Triangle sides (a, b, c). Returns the area of a triangle.
    """
    a = int(input("Enter the value of side a: "))
    b = int(input("Enter the value of side b: "))
    ...
    print(f"The area of a triangle with sides {a}, {b}, {c} is:", s)
