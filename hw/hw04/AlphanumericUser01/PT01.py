...
# Error: Temperature below absolute zero (-273.15°C)qq

temp_celcium = float(input("Enter the temperature in Celsius: "))
temp_fahrenheit = (temp_celcium * 9/5) + 32
if temp_celcium < -273.15:
    print("Temperature below absolute zero (-273.15°C)")
else:
    print(f"""{temp_celcium}°C is equal to {temp_fahrenheit}°F""")
